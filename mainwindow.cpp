...
void MainWindow::InitView()
{
    ...
    btn2 = new MineButton(this);
    btn2->setGeometry(100,100,90,26);
    btn2->setButtonText("Transpate");
...
void MainWindow::InitEvents()
{
    ...
    connect(btn2,SIGNAL(clicked()),this,SLOT(TranspateViewShow()));
}
...
void MainWindow::TranspateViewShow()
{
    viewTranspate = new TranspateView;
    viewTranspate->setMinimumSize(580,357);
    viewTranspate->setMaximumSize(580,357);
    viewTranspate->setWindowOpacity(0.8);
    viewTranspate->exec();
}
